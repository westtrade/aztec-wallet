...
<div class="mx-auto flex min-h-fit max-w-sm grow flex-col items-center justify-center">
	...
	<h1 class="mb-8 text-center font-['Space_Grotesk'] text-3xl font-bold">AZTEC Wallet</h1>

	<p class="text-center text-sm text-gray-400">
		AZTEC wallet allows you to make fast and secure blockhain-based payments without
		intermediates.
	</p>

	<div class="mb-28"></div>

	<div class="grid w-full items-center justify-center gap-8">
		<Button size="lg" class="w-56 font-bold" href="/congratulations">Create My Wallet</Button>
		<Button size="lg" class="w-56" variant="link" href="/restore-wallet"
