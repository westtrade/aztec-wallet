...
<div class="mx-auto flex min-h-fit max-w-sm grow flex-col items-center justify-center">
	...
	<h1 class="mb-8 text-center font-['Space_Grotesk'] text-3xl font-bold">Congratulations</h1>

	<p class="mb-2 text-center text-sm text-gray-400">
		Your AZTEC wallet has just been created. <br /> Only you control it
	</p>

	<p class="mb-28 text-center text-sm text-gray-400">
		To be able to always have access to it, please set up a secure password and write down
		secret words.
	</p>

	<div class="grid w-full items-center justify-center gap-2">
		<Button size="lg" class="w-56 font-bold" href="/secret-words">Continue</Button>
	</div>
</div>
