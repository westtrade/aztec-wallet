...
<div class="mx-auto flex min-h-fit max-w-sm grow flex-col items-center justify-center">
	...
	<h1 class="mb-8 text-center font-['Space_Grotesk'] text-3xl font-bold">Secure password</h1>

	<p class="mb-8 text-center text-sm text-gray-500">
		Please choose a secure password <br /> for confirming your payments.
	</p>

	<div class="grid grid-cols-1 items-center gap-4">
		<Input type="password" class="max-w-xs" autofocus placeholder="Enter your password" />

		<Input type="password" class="max-w-xs" placeholder="Repeat your password" />
	</div>

	<div class="mb-28"></div>

	<div class="grid w-full items-center justify-center gap-2">
		<Button size="lg" class="w-56 font-bold" href="/ready">Continue</Button>
	</div>
</div>
